...
BinaryTree::Vertex::Vertex(const Type& _value,
                           Vertex* _leftEdge,
                           Vertex* _rightEdge)
    : value(_value), leftEdge(_leftEdge), rightEdge(_rightEdge) {}
...
BinaryTree::BinaryTree() : root(nullptr), searchState(), treeSize(0) {}
...
void BinaryTree::deleteByState(const Type& value) {
  ...
  if (searchState.currentVertex->leftEdge == nullptr &&
    ...
    if (searchState.currentVertex->leftEdge == nullptr &&
      ...
      searchState.currentVertex->replaceVertex(
          searchState.currentVertex->rightEdge);
      ...
      if (searchState.currentVertex->leftEdge != nullptr &&
        ...
        searchState.currentVertex->replaceVertex(
            searchState.currentVertex->leftEdge);
        delete deletedVertex;
      } else {
        ...
        searchState.currentVertex->replaceValue(
            deleteState.currentVertex->value);
        delete deletedVertex;
      }
    }
  }
