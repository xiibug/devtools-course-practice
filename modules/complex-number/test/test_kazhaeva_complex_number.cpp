...
TEST(Kazhaeva_Anastasia_ComplexNumberTest1, add) {
...
TEST(Kazhaeva_Anastasia_ComplexNumberTest2, multiplication) {
  ComplexNumber c1(5, 4);
  ComplexNumber c2(6, 2);
...
TEST(Kazhaeva_Anastasia_ComplexNumberTest4, subtraction2) {
  double re1 = 2.5778;
  double re2 = 5.8765;
  double im1 = 4.4578;
  double im2 = 6.234;
